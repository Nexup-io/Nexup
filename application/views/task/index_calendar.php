...
<section id="content" class="content">
    ...
    ?>
    <span class="config_icons hide_data<?php echo $pointer_class; ?>" id="config_icons" data-toggle="tooltip" title="<?php echo $tooltip_locked; ?>" data-placement="bottom">
        <?php
        $allow_move_config = 0;
            ...
            <div id="addTaskDiv" class="item-add-div multi-column-lists">
                ...
                <div id="TaskListDiv" class="column-css new_add_col_custom<?php echo $task_class . $task_list_div_class; ?>">
                    ...
                    <div class="caleneder_div_wrapper">
                        <div class="container">
                            <select id="select_view" class="select_view_class">
                                <option id="option_month">Month</option>
                                <option id="option_week">Week</option>
                                <option id="option_day">Day</option>
                            </select>
                                <div class="calender_div_inner_box">
                                        <div class="div_left_one">
                                                <div class="img_cel">
                                                    <!--<img src="<?php echo base_url(); ?>assets/img/monthly_view_data.png"/>-->
                                                </div>
                                        </div>
                                                        ...
                                                        <div class="presentation">
                                                                <div class="row_detail">
                                                                        ...
                                                                        <div class="content_wrap">
                                                                                <div class=""><h2 class="h2_content">Baber</h2></div>
                                ...
                                if (!empty($columns)) {
                                    foreach ($columns as $ids => $col):
                                        ...
                                        <div class="add-data-title-r">
                                            <a href="" class="icon-more-h move_col ui-sortable-handle" id="dropdownMenu0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="visibility: hidden;"></a>
                                        ...
                                        foreach ($tasks as $ids => $task):
                                            ...
                                            <tr class="<?php echo $completed_class . $hidden_tr_class; ?>">
                                                ...
                                                <td class="icon-more-holder" data-order="<?php echo $task[0]['order']; ?>" data-listid="<?php echo $list_id; ?>" data-taskname="<?php echo $task[0]['TaskName']; ?>">
                                                    <span class="icon-more<?php echo $attendance_class; ?>"></span>
